      ...
      <ul class="navbar-nav">
        <li class="nav-item">
            ...
            <span class="nav-link-text ms-1">Dashboard</span>',
                    ['action' => 'newestData'], ['class' => 'nav-link active', 'escape' => false]);
            } else {
                echo $this->Html->link('<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>shop </title>
            ...
            <span class="nav-link-text ms-1">Dashboard</span>',
            ['action' => 'newestData'], ['class' => 'nav-link', 'escape' => false]);
            }?>
        ...
        <li class="nav-item">
            ...
            <span class="nav-link-text ms-1">Historical Data</span>',
                    ['action' => 'index'], ['class' => 'nav-link active', 'escape' => false]);
            } else {
                echo $this->Html->link('<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
            ...
            <span class="nav-link-text ms-1">Historical Data</span>',
                    ['action' => 'index'], ['class' => 'nav-link', 'escape' => false]);
            } ?>
        </li>
    </div>
  </aside>
